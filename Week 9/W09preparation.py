...
def main():
    ...
    text_list = read_list("Week 9/download.txt")

    # Print the entire list.
    print(text_list)

def read_list(download):
    ...
    with open(download, "rt") as text_file:
...
def main():
    ...
    with open("Week 9/dentists.csv", "rt") as csv_file:
...
def main():
    ...
    with open("Week 9/dentists.csv", "rt") as dentists_file:
...
def main():
    ...
    dentists_list = read_compound_list("Week 9/dentists.csv")
...
def main():
    ...
    dentists_dict = read_dictionary("Week 9/dentists.csv", PHONE_INDEX)
